...
class GraphRendererApp:
    ...
    def update_ui(self):
        self.open_button.grid(row=len(self.unique_color_codes)+2, column=0, padx=5, pady=5, sticky="w")
        ...
        self.avg_connections_label.config(text=f"Avg Num Connections: {self.avgNumConnections}")
